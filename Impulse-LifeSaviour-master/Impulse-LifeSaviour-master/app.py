...
# For Coronavirus
with open("C:\\Users\\mvgop\\Desktop\\Impulse-LifeSaviour-master\\Impulse-LifeSaviour-master\\Coronavirus_logistic", "rb") as f:
    logisticRegression = pickle.load(f)


# For Chronic kidney disease
with open("C:\\Users\\mvgop\\Desktop\\Impulse-LifeSaviour-master\\Impulse-LifeSaviour-master\\CKD_Model", "rb") as f:
    decisionTree = pickle.load(f)

# For Heart Disease
with open("C:\\Users\\mvgop\\Desktop\\Impulse-LifeSaviour-master\\Impulse-LifeSaviour-master\\HeartDisease", "rb") as f:
