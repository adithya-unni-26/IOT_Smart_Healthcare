...
def predicts(inputs):
    ...
    df = pd.read_csv("C:\\Users\\mvgop\\Desktop\\Impulse-LifeSaviour-master\\Impulse-LifeSaviour-master\\Disease_Symptoms.csv")
    ...
    with open("C:\\Users\\mvgop\\Desktop\\Impulse-LifeSaviour-master\\Impulse-LifeSaviour-master\\DiseasePrediction(Dec)", "rb") as f:
